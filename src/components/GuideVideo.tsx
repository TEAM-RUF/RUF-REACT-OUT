...
export function GuideVideo({guideVideoRef, workoutType, isReplay} : GuideVideoProps) {
  return (
    <div className="w-full relative flex justify-center">
      <div className=" absolute flex justify-center pt-5 pb-5 text-white text-4xl font-bold"
      style={{
        // width: VIDEO_WIDTH,
      }}
      >
